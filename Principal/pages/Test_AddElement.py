...
class Test_AddElement(Test_BasePage):
    ...
    elemento_creado =  (By.XPATH, '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div[3]/ul/li/ul/li[9]/div[1]/div/div/div') 
